    ...
    describe('when being instantiated with the default profile ', () => {
        ...
        describe('and with a existing field', () => {
            describe('and without any explicit order specified', () => {
                it('should include it in the Prisma query with an ascending criteria', () => {
                    ...
                    const sortingQueryField = (0, get_1.default)(prismaQuery, queryPath);
        ...
        describe('and with multiple fields', () => {
            ...
            `.replace(/\s/g, ''),
                    ...
                    const hasOnlyValidFields = Object.keys(Object.assign({}, prismaQuery[TEST_QUERY_KEY]))
                        .length === 1;
            ...
            `.replace(/\s/g, ''),
                    ...
                    const hasOnlyUniqueFields = Object.keys(Object.assign({}, prismaQuery[TEST_QUERY_KEY]))
                        .length === 1;
            ...
            `.replace(/\s/g, ''),
                    ...
                    const hasAllUniqueFields = Object.keys(Object.assign({}, prismaQuery[TEST_QUERY_KEY]))
                        .length === 2;
                    ...
                    const sortingQueryFields = queryPaths.map((path) => (0, get_1.default)(prismaQuery, path));
